...
// OriginValueAndKindOutput contains information about the input value, its kind, and the dereferenced value and kind.
...
// OriginTypeAndKindOutput contains information about the input type, its kind, and the dereferenced type and kind.
...
// ValueToInterface converts a reflect.Value to its corresponding Go interface{}.
