...
// OriginValueAndKindOutput stores the original value and kind details.
type OriginValueAndKindOutput struct {
	InputValue  reflect.Value // Reflect value of the input.
	InputKind   reflect.Kind  // Kind of the input value.
	OriginValue reflect.Value // Original value after dereferencing pointers.
	OriginKind  reflect.Kind  // Kind of the original value.
}

// OriginTypeAndKindOutput stores the original type and kind details.
type OriginTypeAndKindOutput struct {
	InputType  reflect.Type // Reflect type of the input.
	InputKind  reflect.Kind // Kind of the input type.
	OriginType reflect.Type // Original type after dereferencing pointers.
	OriginKind reflect.Kind // Kind of the original type.
}
...
// ValueToInterface converts a reflect.Value to its corresponding interface{} type.
